...
nc_school <- nc_school |>
  mutate(
    all_real = total_all/(all*.01),
    female_real = total_female/(female*.01),
    male_real = total_male/(male*.01),
    asian_real = total_asian/(asian*.01),
    black_real = total_black/(black_*.01),
    hispanic_real = total_hispanic/(hispanic*.01),
    multi_real = total_multi/(multi*.01),
    white_real = total_white/(white_*.01),
    EDS_real = total_EDS/(EDS*.01),
    LEP_real = total_LEP/(LEP*.01),
    SWD_real = total_SWD/(SWD*.01)
    )
```
